# Starwood: Key Advantages of the RAVE-DDSP-Transformer Tri-Hybrid Architecture
...
[3] Starwood Project. *Aurora LLM Integration*. (See `docs/Aurora_LLM_Integration.md` in the Starwood repository.)
